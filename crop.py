...
def process_image(path, out_path):
    ...
    # dilated_image = dilate(edges, N=5, iterations=2)
    # edges = np.uint8(dilated_image)
    ...
    temp, contours, hierarchy = cv2.findContours(edges, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
